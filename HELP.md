...
* The original package name 'edu.ignacio.poc.high-throughput' is invalid and this project uses '
  edu.ignacio.poc.high_throughput' instead.
...
```
$ docker run --rm -p 8080:8080 high-throughput:0.0.1-SNAPSHOT
```
